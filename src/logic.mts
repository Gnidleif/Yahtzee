...
export abstract class FreezableBase implements ILogic {
...
export abstract class DieLogicBase extends FreezableBase {
...
export abstract class RuleLogicBase extends FreezableBase {
    private name: string = "";
