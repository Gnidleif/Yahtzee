...
ruleTests.add(new Test("OfAKindLogic update", (o) => { o.update(1, 1, 1, 2, 2); return o.currentScore; }, (x) => TestHandler.assertTrue(x === 3), new l.OfAKindLogic(3)));
ruleTests.add(new Test("OfAKindLogic update frozen", (o) => { o.freeze(); o.update(1, 1, 1, 2, 2); return o.currentScore; }, (x) => TestHandler.assertTrue(x === 0), new l.OfAKindLogic(3)));
...
ruleTests.add(new Test("StraightLogic(4) update", (s) => { s.update(1, 2, 3, 4, 5); return s.currentScore; }, (x) => TestHandler.assertTrue(x === 40), new l.StraightLogic(4)));
ruleTests.add(new Test("StraightLogic(4) update frozen", (s) => { s.freeze(); s.update(1, 2, 3, 4, 5); return s.currentScore; }, (x) => TestHandler.assertTrue(x === 0), new l.StraightLogic(4)));
...
ruleTests.add(new Test("StraightLogic(5) update", (s) => { s.update(1, 2, 3, 4, 5); return s.currentScore; }, (x) => TestHandler.assertTrue(x === 50), new l.StraightLogic(5)));
...
ruleTests.add(new Test("FullHouseLogic update", (f) => { f.update(1, 1, 2, 2, 2); return f.currentScore; }, (x) => TestHandler.assertTrue(x === 50), new l.FullHouseLogic()));
ruleTests.add(new Test("FullHouseLogic update frozen", (f) => { f.freeze(); f.update(1, 1, 2, 2, 2); return f.currentScore; }, (x) => TestHandler.assertTrue(x === 0), new l.FullHouseLogic()));
...
ruleTests.add(new Test("ChanceLogic update", (c) => { c.update(1, 2, 3, 4, 5); return c.currentScore; }, (x) => TestHandler.assertTrue(x === 15), new l.ChanceLogic()));
ruleTests.add(new Test("ChanceLogic update frozen", (c) => { c.freeze(); c.update(1, 2, 3, 4, 5); return c.currentScore; }, (x) => TestHandler.assertTrue(x === 0), new l.ChanceLogic()));
...
ruleTests.add(new Test("YahtzeeLogic update", (y) => { y.update(1, 1, 1, 1, 1); return y.currentScore; }, (x) => TestHandler.assertTrue(x === 100), new l.YahtzeeLogic()));
ruleTests.add(new Test("YahtzeeLogic update frozen", (y) => { y.freeze(); y.update(1, 1, 1, 1, 1); return y.currentScore; }, (x) => TestHandler.assertTrue(x === 0), new l.YahtzeeLogic()));
...
ruleTests.add(new Test("BonusLogic update", (b) => { b.update(5, 5, 5, 5, 5); return b.currentScore; }, (x) => TestHandler.assertTrue(x === 25), new l.BonusLogic(20)));
ruleTests.add(new Test("BonusLogic update frozen", (b) => { b.freeze(); b.update(5, 5, 5, 5, 5); return b.currentScore; }, (x) => TestHandler.assertTrue(x === 0), new l.BonusLogic(20)));
...
ruleTests.add(new Test("RuleDisplay display", (r) => r.display(), (x) => TestHandler.assertType(HTMLElement, x), new d.RuleDisplay("test")));
ruleTests.add(new Test("RuleDisplay update", (r) => { r.update(50); return r.display().querySelector(".score"); }, (x) => TestHandler.assertEquals("50", x.textContent), new d.RuleDisplay("test")));
...
ruleTests.add(new Test("Rule check", (r) => { r.check(1, 2, 3, 4, 5, 6); return r.display(); }, (e) => TestHandler.assertTrue(e.querySelector(".score").textContent === "6"), new c.Rule(new l.NumberOfLogic(6))));
ruleTests.add(new Test("Rule freeze", (r) => { r.htmlElement.click(); return r.htmlElement.classList.contains("frozen"); }, (x) => TestHandler.assertTrue(x), new c.Rule(new l.NumberOfLogic(6))));
ruleTests.add(new Test("Rule unfreeze", (r) => { r.htmlElement.click(); r.htmlElement.click(); return r.htmlElement.classList.contains("frozen"); }, (x) => TestHandler.assertFalse(x), new c.Rule(new l.NumberOfLogic(6))));
//#endregion
